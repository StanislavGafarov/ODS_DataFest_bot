...
# Random prize
TEXT_CHOOSE_YOUR_SIZE = 'Для участия в розыгрыше мерча выбери свой размер. Для каждой категории будет свой отдельный розыгрыш.'
TEXT_KNOW_SIZE = 'Твой размер {}, если захочешь изменить размер нажми соответсвующую кнопку.'
TEXT_CHOOSEN_SIZE = 'Выбран размер {}, удачи в розыгрыше!'
TEXT_СHANGE_SIZE = 'Хорошо, давай выберем новый размер.'
TEXT_START_RANDOM_PRIZE = "{}\nВыбери категорию в которой будет сделан розыгрыш."
