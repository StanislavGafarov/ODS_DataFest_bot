...
TEXT_RULES = 'Random beer это возможность прокачать свой нетворкинг.\n' \
             ...
             'За день у вас может быть несколько встреч, но не больше 3. Удачи!'
...
TEXT_NOT_ENOUGH_INFO = 'У Вас заполнено слишком мало полей для участия, заполните хотябы одно поле.'
TEXT_SHOULD_END_MEETING = 'Прежде чем начать следующую встречу, Вам следует закончить предыдущую.'
TEXT_WRITE_FEEDBACK = "Напишите отзыв о встречи в одном сообщении о том, как это было?"
...
TEXT_MAJOR_CODE_OK = 'Отлично! Теперь вы можете попробовать поучавствовать в Random beer и розыгрыше мерча'
