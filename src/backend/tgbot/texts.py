...
TEXT_CODE_OK = 'Вы авторизовались, теперь Вы можете попробовать поучавствовать в розыгрыше мерчендайза ну или в "Рэндом Пиве"'

# Get news
TEXT_NEWS = "Тут можно подписаться на последние обновления. Ну или посмотреть последние 5 новостей"
TEXT_NEWS_SUBSCRIBED = "Подписка на новости в деле! 🔥"
TEXT_NEWS_UNSUBSCRIBED = "Никаких больше новостей 😢"
