...
TEXT_CHANGE_SIZE = 'Твой размер {}, если захочешь изменить размер нажми соответсвующую кнопку.'
TEXT_CHOOSEN_SIZE = 'Твой размер {}'
TEXT_SUCCESS_SIZE = 'Размер выбран, спасибо за участвие, мы сообщим если ты выйграешь'
