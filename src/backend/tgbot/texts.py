...
TEXT_NEED_SOC_NET_LINK = 'Почти готово, вы можете оставить ссылку на себя в соц. сети или пропустить данный шаг отправив /skip.'
TEXT_RANDOM_BEER_MENU = 'Ваши данные:\n - Telegram nick: {};\n - ODS nick: {};\n - Social network link: {}.'
TEXT_RANDOM_BEER_NOT_ENOUGH_PARTICIPANTS = "К сожалению других участников еще нет, попробуйте найти пару чуть позже."
