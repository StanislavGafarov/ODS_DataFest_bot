...
TEXT_CHANGE_SIZE = 'Хорошо, давай выберем новый размер.'
TEXT_START_RANDOM_PRIZE = "Статистика по юзерам:\n{}\nДанные из Prizes:{}\nВыберите дальнейшие дествия."
TEXT_EMPTY_TABLE_PRIZE = "Таблица Prizes пуста!"
TEXT_CONGRATULATION = 'Поздрравляю Вы выграли приз, забрать приз можно там-то у того-то.'
