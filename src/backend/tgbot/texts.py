...
# Bot messages
TEXT_BOT_UPDATED = "Мы обновились, если ваш бот перестал отвечать нажмите /start"
TEXT_BOT_TESTERS_WANTED = "Ребят, нужен еще один тест бота"
